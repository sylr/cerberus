...
GO_BUILD_TARGET          := dist/cerberus
GO_BUILD_VERSION_TARGET  := dist/cerberus-$(GIT_VERSION)
else
GO_BUILD_TARGET          := dist/cerberus-$(GOOS)-$(GOARCH)
GO_BUILD_VERSION_TARGET  := dist/cerberus-$(GIT_VERSION)-$(GOOS)-$(GOARCH)
endif # $(GOOS)/$(GOARCH)
...
GO_CROSSBUILD_LINUX_TARGET_PATTERN   := dist/cerberus-$(GIT_VERSION)-linux-%
GO_CROSSBUILD_FREEBSD_TARGET_PATTERN := dist/cerberus-$(GIT_VERSION)-freebsd-%
GO_CROSSBUILD_OPENBSD_TARGET_PATTERN := dist/cerberus-$(GIT_VERSION)-openbsd-%
GO_CROSSBUILD_WINDOWS_TARGET_PATTERN := dist/cerberus-$(GIT_VERSION)-windows-%.exe
GO_CROSSBUILD_DARWIN_TARGET_PATTERN  := dist/cerberus-$(GIT_VERSION)-darwin-%
